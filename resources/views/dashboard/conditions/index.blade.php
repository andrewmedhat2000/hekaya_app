...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.conditions.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>

        <div class="box">
            <div class="box-header">
                <h3 class="box-title">All Conditions Info</h3>
            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <a class="btn btn-block btn-primary " style="width: 74.5px;"
                                            href="{{ route('dashboard.conditions.edit',$condition->id) }}">
                                            Edit
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.conditions.destroy',$condition->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
