...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.frames.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>
        ...
        <div class="box">
            ...
            <div class="box-header">
                <h3 class="box-title">All Frames Info</h3>
            </div>
                ...
                <table id="tbl-list-users" data-server="false" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->days_to_expire ? $item->days_to_expire.' days' : ''}}</td>
                            <td>
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <a class="btn btn-block btn-primary " style="width: 74.5px;"
                                            href="{{ route('dashboard.frames.edit',$item->id) }}">
                                            Edit
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.frames.destroy',$item->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
