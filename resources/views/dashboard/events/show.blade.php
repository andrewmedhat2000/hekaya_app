...
<div class="row">
    ...
    <div class="col-md-4 col-md-offset-1 text-right col-xs-11">
        <a href="{{ route('dashboard.events.create') }}" class="btn btn-primary margin-left-10">
            <span>+ </span>Add Event
        </a>
        <a href="{{ route('dashboard.events.edit',$resource->id) }}" class="btn btn-warning margin-left-10">
            Edit Event
        </a>
    </div>
</div>
