...
@section('content')
    ...
    {{ Form::open(['route' => 'dashboard.currencies.store','files'=>'true']) }}
<div class="row">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('code',old('code'),['id'=>'code','required' => 'required','class' => 'form-control']) }}
                    ...
                    <div class="form-group margin-bottom20 col-md-6">
                            ...
                            {{ Form::text('symbol',old('symbol'),['id'=>'symbol','required' => 'required','class' => 'form-control']) }}
