...
{{ Form::open(['route' => ['dashboard.streamer.update',$resource->id],'method' => 'PATCH','files'=>'true','enctype'=>'multipart/form-data']) }}
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group margin-bottom20 col-md-12">
                        ...
                        {{ Form::select('stream_admin_id',$streamer_admins,$selected_streamer_admin,['placeholder' => 'Pick a Streamer Admin','id'=>'stream_admin_id','required' => 'required','class' => 'form-control']) }}
                        <p class="text-danger" style="margin-bottom: 0;">{{ $errors->first('name') }}</p>
                    </div>
                    @endhasanyrole
