...
@stop
@section('content')
    {{ Form::open(['route' => ['dashboard.games-slider.update', $game->id], 'method' => 'PATCH','files' => 'true', 'enctype'=>'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group margin-bottom20 col-md-6">
                                ...
                                {{ Form::text('title', old('title', $game->title ?? ' '), ['id' => 'title', 'class' => 'form-control']) }}
                            ...
                            <div class="form-group margin-bottom20 col-md-6">
                                ...
                                {{ Form::text('link', old('link', $game->link), ['id' => 'round_value', 'required' => 'required', 'class' => 'form-control']) }}
