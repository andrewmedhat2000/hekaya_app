...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.packages.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>
                            ...
                            <td>
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.packages.destroy',$package->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
