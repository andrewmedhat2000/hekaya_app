...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.backgrounds.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>
        ...
        <div class="box">
            ...
            <div class="box-header">
                <h3 class="box-title">All Backgrounds Info</h3>
            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <a class="btn btn-block btn-primary " style="width: 74.5px;"
                                            href="{{ route('dashboard.backgrounds.edit',$item->id) }}">
                                            Edit
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.backgrounds.destroy',$item->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
