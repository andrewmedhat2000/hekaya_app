...
@section('content_header')
    <h1>Edit Lucky Gift</h1>
@stop
@section('content')
    {{ Form::open(['route' => ['dashboard.lucky-gift.update', $luckyGift->id], 'method' => 'PATCH', 'files' => 'true', 'enctype'=>'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group margin-bottom20 col-md-6">
                                ...
                                {{ Form::text('name', old('name', $luckyGift->name), ['id' => 'name', 'required' => 'required', 'class' => 'form-control']) }}
                            ...
                            <div class="form-group margin-bottom20 col-md-6">
                                ...
                                {{ Form::number('price', old('price', $luckyGift->price), ['id' => 'price', 'required' => 'required', 'class' => 'form-control']) }}
