...
{{ Form::open(['route' => ['dashboard.admin.update',$resource->id],'method' => 'PATCH','files'=>'true','enctype'=>'multipart/form-data']) }}
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('phone',$resource->phone,['id'=>'phone','required' => 'required','class' => 'form-control only-numeric']) }}
