...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.category.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>
                            ...
                            <td>
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.category.destroy',$category->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
