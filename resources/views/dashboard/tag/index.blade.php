...
<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <a href="{{ route('dashboard.tag.create') }}" class="btn btn-block btn-primary">
            Add new
        </a>

        <div class="box">
            <div class="box-header">
                <h3 class="box-title">All Tag Info</h3>
            </div>
                            ...
                            <td>
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{ Form::open(['route' => ['dashboard.tag.destroy',$tag->id] ,'method' => 'DELETE' ,'class' => 'delete-form']) }}
